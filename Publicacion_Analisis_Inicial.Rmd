...
## 1. Informacion preliminar del conjunto de datos
...
### 1.1. Verificacion de existencia de valores perdidos (Missing Values - NA's)
...
-   used_pin_number: en este item, un número alrededor de 87.100 observaciones (cerca del 10%) que mencionan el no uso de pin (clave) de la tarjeta se tipificaron como fraude. Cuando se registra uso del pin de la tarjeta el porcentaje de fraude identificado es inferior al 0.3% (273 transacciones)
